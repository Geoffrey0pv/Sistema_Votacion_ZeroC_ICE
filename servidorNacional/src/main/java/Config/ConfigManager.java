...
public class ConfigManager {
    ...
    private void loadDefaultProperties() {
        // Valores por defecto para base de datos
        properties.setProperty("db.host", "x104m01");
        properties.setProperty("db.port", "5432");
        properties.setProperty("db.name", "elecciones_grajj");
        ...
        properties.setProperty("db.pool.minSize", "2");
    ...
    public String getDatabaseUrl() {
        ...
        String dbName = getProperty("db.name", "elecciones_grajj");
    ...
    public int getPoolMinSize() {
        return getIntProperty("db.pool.minSize", 2);
    }
